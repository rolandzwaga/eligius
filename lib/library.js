...
function () {
  ...
  _createClass(ChronoTriggerEngine, [{
    ...
    value: function _addInitialisationListeners() {
      ...
      this._eventbusListeners.push(this._eventbus.on(_timelineEventNames["default"].REQUEST_CURRENT_TIMELINE_POSITION, this._handleRequestTimelinePosition.bind(this)));
