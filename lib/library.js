  ...
  _createClass(ChronoTriggerEngine, [{
    ...
    value: function init() {
      ...
      var _this$_configuration = this._configuration,
          language = _this$_configuration.language,
          labels = _this$_configuration.labels,
          timelines = _this$_configuration.timelines;
      var _eventbus = this._eventbus;
      this._languageManager = new _languageManager["default"](language, labels, _eventbus);
...
function () {
  ...
  _createClass(EngineFactory, [{
    ...
    value: function createEngine(configuration, resolver) {
      ...
      var chronoTriggerEngine = new engineClass(configuration, this._eventbus, timelineProvider);
      return chronoTriggerEngine;
    }
  }]);
