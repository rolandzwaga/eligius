...
function () {
  ...
  _createClass(ActionCreatorFactory, [{
    ...
    value: function createAction(name) {
      var creator = new ActionCreator(this, name);
    ...
    value: function createInitAction(name) {
      var creator = new EndableActionCreator(this, name);
    ...
    value: function createTimelineAction(uri, name) {
      var creator = new TimelineActionCreator(this, name);
...
/*#__PURE__*/
function () {
  function ActionCreator(factory, name) {
  ...
  _createClass(ActionCreator, [{
    ...
    value: function getConfiguration(callBack) {
      var newConfig = callBack.call(null, this.actionConfig);
...
function (_ActionCreator) {
  ...
  function EndableActionCreator(factory, name) {
    _classCallCheck(this, EndableActionCreator);

    return _possibleConstructorReturn(this, _getPrototypeOf(EndableActionCreator).call(this, factory, name));
  }
...
/*#__PURE__*/
function () {
  function ActionEditor(configurationFactory, actionConfig) {
...
function () {
  ...
  _createClass(ConfigurationFactory, [{
    ...
    value: function editAction(id) {
      ...
      if (actionConfig) {
        return new _actionEditor.ActionEditor(this, actionConfig);
      }
    ...
    value: function editInitAction(id) {
      ...
      if (actionConfig) {
        return new _actionEditor.EndableActionEditor(this, actionConfig);
      }
    ...
    value: function editTimelineAction(uri, id) {
      ...
      if (actionConfig) {
        return new _actionEditor.TimelineActionEditor(this, actionConfig);
      }
