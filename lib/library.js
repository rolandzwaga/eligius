...
var Action = /*#__PURE__*/function () {
  function Action(actionConfiguration, eventBus) {
  ...
  _createClass(Action, [{
    ...
    value: function executeOperation(operations, idx, resolve, reject, previousOperationData, context) {
      var _this2 = this;
      ...
      if (idx < operations.length) {
        ...
        var result = operationInfo.instance.call(context, mergedOperationData, this.eventbus);
...
var EndableAction = /*#__PURE__*/function (_Action) {
  ...
  function EndableAction(actionConfigration, eventBus) {
    var _this;

    _classCallCheck(this, EndableAction);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(EndableAction).call(this, actionConfigration, eventBus));
    _this.endOperations = actionConfigration.endOperations;
    return _this;
  }
  ...
  _createClass(TimelineAction, [{
    ...
    value: function start(initOperationData) {
      if (!this.active || this.duration.end < 0) {
        ...
        return _get(_getPrototypeOf(TimelineAction.prototype), "start", this).call(this, initOperationData);
      }
 ...
 * ...
 */
var ChronoTriggerEngine = /*#__PURE__*/function () {
  function ChronoTriggerEngine(configuration, eventbus, timelineProviders, languageManager) {
  ...
  _createClass(ChronoTriggerEngine, [{
    ...
    value: function init() {
      ...
      var timelines = this._configuration.timelines;
    ...
    value: function _createLayoutTemplate() {
      ...
      if (!container || !container.length) {
        throw new Error("Container selector not found: ".concat(containerSelector));
      }

      var layoutTemplate = this._configuration.layoutTemplate;
    ...
    value: function _initializeTimelineProvider() {
      ...
      var firstTimeline = this._configuration.timelines[0];
      var providerSettings = this._timelineProviders[firstTimeline.type];
      ...
      return new Promise(function (resolve) {
        _this._activeTimelineProvider.init(firstTimeline.selector).then(function () {
          _this._executeActions(_this._configuration.initActions, 'start').then(function () {
            _this._activeTimelineProvider.on(_timelineEventNames["default"].TIME, _this._onTimeHandler.bind(_this, Math.floor));

            _this._activeTimelineProvider.on(_timelineEventNames["default"].SEEK, _this._onSeekHandler.bind(_this, Math.floor));
    ...
    key: "_cleanUp",
    value: function () {
      var _cleanUp2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _context.next = 4;
                return this._executeActions(this._configuration.initActions, 'end');
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                this._eventbus = null;
                Object.values(this._timelineProviders).forEach(function (provider) {
                  provider.destroy();
                });
    ...
    value: function _addInitialisationListeners() {
      this._eventbusListeners.push(this._eventbus.on(_timelineEventNames["default"].REQUEST_ENGINE_ROOT, this._handleRequestEngineRoot.bind(this, this._configuration.containerSelector)));

      this._eventbusListeners.push(this._eventbus.on(_timelineEventNames["default"].REQUEST_TIMELINE_URI, this._handleRequestTimelineUri.bind(this)));

      this._eventbusListeners.push(this._eventbus.on(_timelineEventNames["default"].REQUEST_CURRENT_TIMELINE_POSITION, this._handleRequestTimelinePosition.bind(this, Math.floor)));

      this._eventbusListeners.push(this._eventbus.on(_timelineEventNames["default"].REQUEST_TIMELINE_CLEANUP, this._handleTimelineComplete.bind(this)));

      this._eventbusListeners.push(this._eventbus.on(_timelineEventNames["default"].EXECUTE_TIMELINEACTION, this._handleExecuteTimelineAction.bind(this)));

      this._eventbusListeners.push(this._eventbus.on(_timelineEventNames["default"].RESIZE_TIMELINEACTION, this._resizeTimelineAction.bind(this)));
    }
  }, {
    ...
    value: function _createTimelineLookup() {
      ...
      this._configuration.timelines.forEach(function (timelineInfo) {
    ...
    value: function _handleRequestTimelineUri(uri, position, previousVideoPosition) {
      var _this4 = this;
      ...
      this._cleanUpTimeline().then(function () {
        var timelineConfig = _this4._configuration.timelines.find(function (timeline) {
          return timeline.uri === uri;
        });

        _this4._currentTimelineUri = timelineConfig.uri;
        var newProviderSettings = _this4._timelineProviders[timelineConfig.type];

        if (_this4._activeTimelineProvider !== newProviderSettings.provider) {
          _this4._activeTimelineProvider.destroy();

          _this4._activeTimelineProvider = newProviderSettings.provider;
        }

        _this4._activeTimelineProvider.loop = timelineConfig.loop;

        if (!_this4._activeTimelineProvider.loop && position > 0) {
          _this4._activeTimelineProvider.once(_timelineEventNames["default"].FIRST_FRAME, function () {
            _this4._activeTimelineProvider.pause();

            _this4._eventbus.broadcastForTopic(_timelineEventNames["default"].DURATION, _this4._activeTimelineProvider.playerid, [_this4.getDuration()]);

            _this4._executeStartActions().then(function () {
              _this4._activeTimelineProvider.seek(position);
        ...
        _this4._activeTimelineProvider.playlistItem(uri);
      });
    }
  }, {
    ...
    value: function _handleRequestTimelinePosition(floor, resultCallback) {
    ...
    value: function _getTimelineActionsForUri(uri) {
      ...
      this._configuration.timelines.some(function (timelineInfo) {
    ...
    value: function _onTimeHandler(floor, event) {
      if (!isNaN(event.position)) {
        ...
        if (this._lastPosition !== pos) {
          ...
          this._eventbus.broadcastForTopic(_timelineEventNames["default"].POSITION_UPDATE, this._activeTimelineProvider.playerid, [pos, this._activeTimelineProvider.getDuration()]);
        }

        this._eventbus.broadcastForTopic(_timelineEventNames["default"].TIME_UPDATE, this._activeTimelineProvider.playerid, [event.position, this._activeTimelineProvider.getDuration()]);
      }
    }
  }, {
    key: "_onSeekHandler",
    value: function _onSeekHandler(floor, event) {
      ...
      this._executeSeekActions(pos).then(function () {
        _this5._activeTimelineProvider.play();
      });
    }
  }, {
...
var ActionCreatorFactory = /*#__PURE__*/function () {
  function ActionCreatorFactory(configfactory) {
    _classCallCheck(this, ActionCreatorFactory);

    this.configfactory = null;
    this.configfactory = configfactory;
  }

  _createClass(ActionCreatorFactory, [{
    key: "createAction",
    value: function createAction(name) {
      var creator = new ActionCreator(name, this);
      this.configfactory.addAction(creator.actionConfig);
      return creator;
    }
  }, {
    key: "createInitAction",
    value: function createInitAction(name) {
      var creator = new EndableActionCreator(name, this);
      this.configfactory.addInitAction(creator.actionConfig);
      return creator;
    }
  }, {
    key: "createEventAction",
    value: function createEventAction(name) {
      var creator = new ActionCreator(name, this);
      this.configfactory.addEventAction(creator.actionConfig);
      return creator;
    }
  }, {
    key: "createTimelineAction",
    value: function createTimelineAction(uri, name) {
      var creator = new TimelineActionCreator(name, this);
...
var ActionCreator = /*#__PURE__*/function () {
  function ActionCreator(name, factory) {
  ...
  _createClass(ActionCreator, [{
    ...
    value: function getConfiguration(callBack) {
      var copy = (0, _deepcopy["default"])(this.actionConfig);
      var newConfig = callBack.call(this, copy);
    ...
    key: "addStartOperation",
    value: function addStartOperation(systemName, operationData) {
      if (!operations[systemName]) {
        throw Error("Unknown operation: ".concat(systemName));
      }

      var startOperations = this.actionConfig.startOperations;
...
var EndableActionCreator = /*#__PURE__*/function (_ActionCreator) {
  _inherits(EndableActionCreator, _ActionCreator);

  function EndableActionCreator() {
    _classCallCheck(this, EndableActionCreator);

    return _possibleConstructorReturn(this, _getPrototypeOf(EndableActionCreator).apply(this, arguments));
  }

  _createClass(EndableActionCreator, [{
    key: "addEndOperation",
    value: function addEndOperation(systemName, operationData) {
      if (!operations[systemName]) {
        throw Error("Unknown operation: ".concat(systemName));
      }

      var endOperations = this.actionConfig.endOperations;
  ...
  return EndableActionCreator;
}(ActionCreator);

exports.EndableActionCreator = EndableActionCreator;

var TimelineActionCreator = /*#__PURE__*/function (_EndableActionCreator) {
  _inherits(TimelineActionCreator, _EndableActionCreator);

  function TimelineActionCreator() {
    _classCallCheck(this, TimelineActionCreator);

    return _possibleConstructorReturn(this, _getPrototypeOf(TimelineActionCreator).apply(this, arguments));
  }

  _createClass(TimelineActionCreator, [{
    key: "addDuration",
    value: function addDuration(start, end) {
...
var ActionEditor = /*#__PURE__*/function () {
  function ActionEditor(actionConfig, configurationFactory) {
  ...
  _createClass(ActionEditor, [{
    ...
    value: function updateConfiguration() {
      this.actionConfig = _objectSpread({}, this.actionConfig);
    }
  }, {
    key: "getConfiguration",
    value: function getConfiguration(callBack) {
    ...
    value: function addStartOperation(systemName, operationData) {
      ...
      var startOperations = this.actionConfig.startOperations ? this.actionConfig.startOperations.slice() : [];
      var newConfig = {
        id: (0, _uuid.v4)(),
        systemName: systemName,
        operationData: operationData
    ...
    key: "editStartOperation",
    value: function editStartOperation(id) {
      var startOperations = this.actionConfig.startOperations;
      var operation = startOperations.find(function (o) {
        return o.id === id;
      });
      ...
      throw new Error("operation not found for id ".concat(id));
    }
  }, {
    key: "removeStartOperation",
    value: function removeStartOperation(id) {
      var startOperations = this.actionConfig.startOperations ? this.actionConfig.startOperations.slice() : [];
      var operation = startOperations.find(function (o) {
        return o.id === id;
      });
      var idx = startOperations.indexOf(operation);
    ...
    key: "moveStartOperation",
    value: function moveStartOperation(id, direction) {
      var startOperations = this.actionConfig.startOperations ? this.actionConfig.startOperations.slice() : [];
      var operation = startOperations.find(function (o) {
        return o.id === id;
      });
...
var EndableActionEditor = /*#__PURE__*/function (_ActionEditor) {
  _inherits(EndableActionEditor, _ActionEditor);

  function EndableActionEditor() {
    _classCallCheck(this, EndableActionEditor);

    return _possibleConstructorReturn(this, _getPrototypeOf(EndableActionEditor).apply(this, arguments));
  }

  _createClass(EndableActionEditor, [{
    key: "addEndOperation",
    value: function addEndOperation(systemName, operationData) {
      if (!operations[systemName]) {
        throw Error("Unknown operation: ".concat(systemName));
      ...
      var endOperations = this.actionConfig.endOperations ? this.actionConfig.endOperations.slice() : [];
      var newConfig = {
        id: (0, _uuid.v4)(),
        systemName: systemName,
        operationData: operationData
    ...
    key: "editEndOperation",
    value: function editEndOperation(id) {
      var endOperations = this.actionConfig.endOperations;
      var operationConfig = endOperations.find(function (o) {
        return o.id === id;
      });
    ...
    key: "removeEndOperation",
    value: function removeEndOperation(id) {
      var endOperations = this.actionConfig.endOperations ? this.actionConfig.endOperations.slice() : [];
      var operation = endOperations.find(function (o) {
        return o.id === id;
      });
      var idx = endOperations.indexOf(operation);
    ...
    key: "moveEndOperation",
    value: function moveEndOperation(id, direction) {
      var endOperations = this.actionConfig.endOperations ? this.actionConfig.endOperations.slice() : [];
      var operation = endOperations.find(function (o) {
        return o.id === id;
      });
  ...
  return EndableActionEditor;
}(ActionEditor);

exports.EndableActionEditor = EndableActionEditor;

var TimelineActionEditor = /*#__PURE__*/function (_EndableActionEditor) {
  _inherits(TimelineActionEditor, _EndableActionEditor);

  function TimelineActionEditor() {
    _classCallCheck(this, TimelineActionEditor);

    return _possibleConstructorReturn(this, _getPrototypeOf(TimelineActionEditor).apply(this, arguments));
  }

  _createClass(TimelineActionEditor, [{
    key: "setDuration",
  ...
  return TimelineActionEditor;
}(EndableActionEditor);

exports.TimelineActionEditor = TimelineActionEditor;

var OperationEditor = /*#__PURE__*/function () {
  function OperationEditor(operationConfig, actionEditor) {
    _classCallCheck(this, OperationEditor);
  ...
  _createClass(OperationEditor, [{
    key: "getConfiguration",
    value: function getConfiguration(callBack) {
      var copy = (0, _deepcopy["default"])(this.operationConfig);
      var newConfig = callBack.call(this, copy);
    ...
    key: "setOperationData",
    value: function setOperationData(operationData) {
      this.operationConfig.operationData = operationData;
      this.actionEditor.updateConfiguration();
      return this;
    }
  }, {
    key: "setOperationDataItem",
    value: function setOperationDataItem(key, value) {
      var operationData = this.operationConfig.operationData;

      if (!operationData) {
        operationData = (_readOnlyError("operationData"), {});
      }
    ...
    key: "getOperationDataKeys",
    value: function getOperationDataKeys() {
      var operationData = this.operationConfig.operationData;
      return operationData ? Object.keys(operationData) : [];
    }
  }, {
    key: "getOperationDataValue",
    value: function getOperationDataValue(key) {
      var operationData = this.operationConfig.operationData;
...
var _actionCreatorFactory = __webpack_require__(/*! ./action-creator-factory */ "./src/configuration/api/action-creator-factory.js");

var _actionEditor = __webpack_require__(/*! ./action-editor */ "./src/configuration/api/action-editor.js");

var _timelineProviderSettingsEditor = _interopRequireDefault(__webpack_require__(/*! ./timeline-provider-settings-editor */ "./src/configuration/api/timeline-provider-settings-editor.js"));
...
var ConfigurationFactory = /*#__PURE__*/function () {
  function ConfigurationFactory(config) {
    _classCallCheck(this, ConfigurationFactory);

    this.actionCreatorFactory = null;
    this.configuration = null;
    this.configuration = config || {};
    this.actionCreatorFactory = new _actionCreatorFactory.ActionCreatorFactory(this);
  }

  _createClass(ConfigurationFactory, [{
    key: "init",
    value: function init(defaultLanguage) {
      this.configuration = {
        id: (0, _uuid.v4)(),
        engine: {
    ...
    key: "setContainerSelector",
    value: function setContainerSelector(selector) {
      this.configuration.containerSelector = selector;
      return this;
    }
  }, {
    key: "editTimelineProviderSettings",
    value: function editTimelineProviderSettings() {
      return new _timelineProviderSettingsEditor["default"](this.configuration.timelineProviderSettings, this);
    }
  }, {
    key: "getConfiguration",
    value: function getConfiguration(callBack) {
      var copy = (0, _deepcopy["default"])(this.configuration);
      var newConfig = callBack.call(this, copy);
    ...
    key: "addLanguage",
    value: function addLanguage(code, languageLabel) {
      var languages = this._initializeCollection(this.configuration, 'availableLanguages');
    ...
    key: "_internalAddAction",
    value: function _internalAddAction(collectionName, action) {
      var actions = this._initializeCollection(this.configuration, collectionName);

      actions.push(action);
    }
  }, {
    key: "_initializeCollection",
    value: function _initializeCollection(parent, name) {
      if (!parent[name]) {
        parent[name] = [];
      }
    ...
    key: "addInitAction",
    value: function addInitAction(action) {
      this._internalAddAction('initActions', action);
    }
  }, {
    key: "addEventAction",
    value: function addEventAction(action) {
      this._internalAddAction('eventActions', action);
    }
  }, {
    key: "addTimelineAction",
    value: function addTimelineAction(uri, action) {
      var timeline = this.getTimeline(uri);

      if (timeline) {
        var timelineActions = this._initializeCollection(timeline, 'timelineActions');

        timelineActions.push(action);
      } else {
        throw Error("No timeline found for uri '".concat(uri, "'"));
      }
    }
  }, {
    key: "createAction",
    ...
    key: "addTimeline",
    value: function addTimeline(uri, type, duration, loop, selector) {
      var timelines = this._initializeCollection(this.configuration, 'timelines');

      var timeline = this.getTimeline(uri);

      if (timeline) {
        throw Error("timeline for uri ".concat(uri, " already exists"));
      }
    ...
    key: "getTimeline",
    value: function getTimeline(uri) {
      return this.configuration.timelines ? this.configuration.timelines.find(function (t) {
        return t.uri === uri;
      }) : null;
    }
  }, {
    key: "removeTimeline",
    value: function removeTimeline(uri) {
      if (!this.configuration.timelines) {
        return;
      }

      var timelineConfig = this.getTimeline(uri);

      if (timelineConfig) {
        var idx = this.configuration.timelines.indexOf(timelineConfig);
    ...
    key: "_initializeLabel",
    value: function _initializeLabel(id, labels) {
    ...
    key: "_getLabelTranslation",
    value: function _getLabelTranslation(labelTranslations, languageCode) {
      var translation = labelTranslations.find(function (l) {
    ...
    key: "addLabel",
    value: function addLabel(id, code, translation) {
      var labels = this._initializeCollection(this.configuration, 'labels');

      var labelConfig = this._initializeLabel(id, labels);

      var labelTranslation = this._getLabelTranslation(labelConfig.labels, code);
    ...
    key: "editAction",
    value: function editAction(id) {
      var actionConfig = this.configuration.actions.find(function (a) {
        return a.id === id;
      });

      if (actionConfig) {
        return new _actionEditor.ActionEditor(actionConfig, this);
      }

      throw new Error("Action not found for id ".concat(id));
    }
  }, {
    key: "editEventAction",
    value: function editEventAction(id) {
      var actionConfig = this.configuration.eventActions.find(function (a) {
        return a.id === id;
      });
      ...
      throw new Error("Event action not found for id ".concat(id));
    }
  }, {
    key: "editInitAction",
    value: function editInitAction(id) {
      var actionConfig = this.configuration.initActions.find(function (a) {
        return a.id === id;
      });

      if (actionConfig) {
        return new _actionEditor.EndableActionEditor(actionConfig, this);
      }

      throw new Error("Init action not found for id ".concat(id));
    }
  }, {
    key: "editTimelineAction",
    value: function editTimelineAction(uri, id) {
      var timeline = this.getTimeline(uri);

      if (!timeline) {
        throw new Error("Timeline not found for id ".concat(id));
      }

      var actionConfig = timeline.timelineActions.find(function (a) {
        return a.id === id;
      });

      if (actionConfig) {
        return new _actionEditor.TimelineActionEditor(actionConfig, this);
      }

      throw new Error("Timeline action not found for id ".concat(id));
    }
  }]);
...
var _default = ConfigurationFactory;
exports["default"] = _default;
...
var operationMetadata = _interopRequireWildcard(__webpack_require__(/*! ../../operation/metadata */ "./src/operation/metadata/index.js"));
...
var OperationNamesProvider = /*#__PURE__*/function () {
  function OperationNamesProvider() {
    _classCallCheck(this, OperationNamesProvider);
  }

  _createClass(OperationNamesProvider, [{
  ...
  return OperationNamesProvider;
}();

exports.OperationNamesProvider = OperationNamesProvider;

var ControllerNamesProvider = /*#__PURE__*/function () {
  function ControllerNamesProvider() {
    _classCallCheck(this, ControllerNamesProvider);
  }

  _createClass(ControllerNamesProvider, [{
  ...
  return ControllerNamesProvider;
}();

exports.ControllerNamesProvider = ControllerNamesProvider;

var OperationMetadataProvider = /*#__PURE__*/function () {
  function OperationMetadataProvider() {
    _classCallCheck(this, OperationMetadataProvider);
  }

  _createClass(OperationMetadataProvider, [{
    key: "getOperationMetadata",
    value: function getOperationMetadata(operationName) {
      var getMetadata = operationMetadata[operationName];

      if (!getMetadata) {
        throw new Error("Cound not find metadata for operation called ".concat(operationName));
      }
  ...
  return OperationMetadataProvider;
}();

exports.OperationMetadataProvider = OperationMetadataProvider;

var TimeLineEventNamesProvider = /*#__PURE__*/function () {
  function TimeLineEventNamesProvider() {
    _classCallCheck(this, TimeLineEventNamesProvider);
  }

  _createClass(TimeLineEventNamesProvider, [{
    key: "getEventNames",
    value: function getEventNames() {
      return Object.values(_timelineEventNames["default"]);
    }
  }]);

  return TimeLineEventNamesProvider;
}();
...
var timelineProviders = _interopRequireWildcard(__webpack_require__(/*! ../../timelineproviders */ "./src/timelineproviders/index.js"));
...
var TimelineProviderSettingsEditor = /*#__PURE__*/function () {
  function TimelineProviderSettingsEditor(providerSettings, configurationFactory) {
    _classCallCheck(this, TimelineProviderSettingsEditor);

    this.providerSettings = providerSettings;
    this.configurationFactory = configurationFactory;
  }

  _createClass(TimelineProviderSettingsEditor, [{
    key: "setVendor",
    value: function setVendor(vendor) {
    ...
    value: function setSystemname(systemName) {
      if (!timelineProviders[systemName]) {
        throw new Error("Unknown timelineprovider system name: ".concat(systemName));
      }
  ...
  return TimelineProviderSettingsEditor;
}();
...
var ConfigurationResolver = /*#__PURE__*/function () {
  ...
  _createClass(ConfigurationResolver, [{
    ...
    value: function resolveOperations(config) {
      ...
      if (config.timelines) {
        config.timelines.forEach(function (timelineInfo) {
          timelineOperations.push.apply(timelineOperations, _this5._gatherOperations(timelineInfo.timelineActions));
        });
      }
    ...
    value: function _gatherOperations(actions) {
      ...
      return actions.reduce(function (list, action) {
  ...
  _createClass(EventListenerController, [{
    ...
    value: function attach(eventbus) {
      ...
      if (!this.actionInstanceInfos) {
        ...
        var resultCallback = function resultCallback(isStart) {
        ...
        actions.forEach(function (actionName) {
          ...
          eventbus.broadcast(_timelineEventNames["default"].REQUEST_ACTION, [name, resultCallback(isStart)]);
        });
...
var LottieController = /*#__PURE__*/function () {
  ...
  _createClass(LottieController, [{
    ...
    value: function attach(eventbus) {
      ...
      if (labelIds && labelIds.length) {
        var resultHolder = {};
        eventbus.broadcast(_timelineEventNames["default"].REQUEST_CURRENT_LANGUAGE, [resultHolder]);
        this.currentLanguage = resultHolder.language;
        this.listeners.push(eventbus.on(_timelineEventNames["default"].LANGUAGE_CHANGE, this.handleLanguageChange.bind(this)));
        eventbus.broadcast(_timelineEventNames["default"].REQUEST_LABEL_COLLECTIONS, [this.operationData.labelIds, resultHolder]);
...
var ProgressbarController = /*#__PURE__*/function () {
  ...
  _createClass(ProgressbarController, [{
    ...
    value: function attach(eventbus) {
      ...
      var callBack = function callBack(providerId) {
        _this.detachers.push(eventbus.on(_timelineEventNames["default"].POSITION_UPDATE, _this.positionUpdateHandler.bind(_this), providerId));
      };

      eventbus.broadcast(_timelineEventNames["default"].PROVIDERID_REQUEST, [callBack]);
    ...
    value: function positionUpdateHandler(_ref) {
...
var RoutingController = /*#__PURE__*/function () {
...
var SubtitlesController = /*#__PURE__*/function () {
  ...
  _createClass(SubtitlesController, [{
    ...
    value: function attach(eventbus) {
      ...
      var callBack = function callBack(providerId) {
        var detachTime = eventbus.on(_timelineEventNames["default"].TIME, _this.onTimeHandler.bind(_this), providerId);
        var detachLangChange = eventbus.on(_timelineEventNames["default"].LANGUAGE_CHANGE, _this.languageChangeHandler.bind(_this));
        _this.internalDetach = _this.internalDetach.bind(_this, [detachTime, detachLangChange]);
      };
    ...
    key: "onTimeHandler",
    value: function onTimeHandler(_ref) {
      var position = _ref.position;
    ...
    value: function createActionLookup(operationData, container) {
...
var _mousetrap = _interopRequireDefault(__webpack_require__(/*! mousetrap */ "mousetrap"));
...
var EngineFactory = /*#__PURE__*/function () {
  ...
  _createClass(EngineFactory, [{
    ...
    value: function _init(importer, windowRef, eventbus) {
      ...
      this._eventbus = eventbus || new _eventbus.Eventbus();

      this._eventbus.on(_timelineEventNames["default"].REQUEST_INSTANCE, this._requestInstanceHandler.bind(this));

      this._eventbus.on(_timelineEventNames["default"].REQUEST_ACTION, this._requestActionHandler.bind(this));

      this._eventbus.on(_timelineEventNames["default"].REQUEST_FUNCTION, this._requestFunctionHandler.bind(this));
    ...
    value: function _resizeHandler() {
      ...
      this._resizeTimeout = setTimeout(function () {
        _this._eventbus.broadcast(_timelineEventNames["default"].RESIZE);
      }, 200);
    }
  }, {
    ...
    value: function _requestActionHandler(systemName, resultCallback) {
      var action = this._actionsLookup[systemName];
    ...
    value: function createEngine(configuration, resolver) {
      ...
      this._eventbus.registerInterceptor(_timelineEventNames["default"].REQUEST_TIMELINE_URI, new _eventbus.RequestVideoUriInterceptor(this._eventbus));

      resolver = resolver || new _configurationResolver["default"](this._importer, this._eventbus);
      this._actionsLookup = resolver.process(actionRegistryListener, configuration);

      var timelineProviders = this._createTimelineProviders(configuration, this._eventbus);

      var language = configuration.language,
          labels = configuration.labels;
      var languageManager = new _languageManager["default"](language, labels, this._eventbus);
      var chronoTriggerEngine = new engineClass(configuration, this._eventbus, timelineProviders, languageManager);

      _mousetrap["default"].bind('space', function (event) {
        event.preventDefault();

        _this2._eventbus.broadcastForTopic(_timelineEventNames["default"].PLAY_TOGGLE_REQUEST, chronoTriggerEngine._activeTimelineProvider.providerid);
    ...
    key: "_createTimelineProviders",
    value: function _createTimelineProviders(configuration, eventbus) {
      var _this3 = this;
...
var WebpackResourceImporter = /*#__PURE__*/function () {
...
Object.defineProperty(exports, "ConfigurationFactory", {
  enumerable: true,
  get: function get() {
    return _configurationFactory["default"];
  }
});
Object.defineProperty(exports, "ActionEditor", {
  enumerable: true,
  get: function get() {
    return _actionEditor.ActionEditor;
  }
});
Object.defineProperty(exports, "EndableActionEditor", {
  enumerable: true,
  get: function get() {
    return _actionEditor.EndableActionEditor;
  }
});
Object.defineProperty(exports, "TimelineActionEditor", {
  enumerable: true,
  get: function get() {
    return _actionEditor.TimelineActionEditor;
  }
});
Object.defineProperty(exports, "OperationEditor", {
  enumerable: true,
  get: function get() {
    return _actionEditor.OperationEditor;
  }
});
Object.defineProperty(exports, "ActionCreatorFactory", {
  enumerable: true,
  get: function get() {
    return _actionCreatorFactory.ActionCreatorFactory;
  }
});
Object.defineProperty(exports, "ActionCreator", {
  enumerable: true,
  get: function get() {
    return _actionCreatorFactory.ActionCreator;
  }
});
Object.defineProperty(exports, "EndableActionCreator", {
  enumerable: true,
  get: function get() {
    return _actionCreatorFactory.EndableActionCreator;
  }
});
Object.defineProperty(exports, "TimelineActionCreator", {
  enumerable: true,
  get: function get() {
    return _actionCreatorFactory.TimelineActionCreator;
  }
});
Object.defineProperty(exports, "OperationNamesProvider", {
  enumerable: true,
  get: function get() {
    return _nameProviders.OperationNamesProvider;
  }
});
Object.defineProperty(exports, "ControllerNamesProvider", {
  enumerable: true,
  get: function get() {
    return _nameProviders.ControllerNamesProvider;
  }
});
Object.defineProperty(exports, "OperationMetadataProvider", {
  enumerable: true,
  get: function get() {
    return _nameProviders.OperationMetadataProvider;
  }
});
Object.defineProperty(exports, "TimeLineEventNamesProvider", {
  enumerable: true,
  get: function get() {
    return _nameProviders.TimeLineEventNamesProvider;
  }
});
Object.defineProperty(exports, "TimelineProviderSettingsEditor", {
  enumerable: true,
  get: function get() {
    return _timelineProviderSettingsEditor["default"];
  }
});
Object.defineProperty(exports, "ParameterTypes", {
  enumerable: true,
  get: function get() {
    return _ParameterTypes["default"];
  }
});
exports["default"] = void 0;
...
var _configurationFactory = _interopRequireDefault(__webpack_require__(/*! ./configuration/api/configuration-factory */ "./src/configuration/api/configuration-factory.js"));

var _actionEditor = __webpack_require__(/*! ./configuration/api/action-editor */ "./src/configuration/api/action-editor.js");

var _actionCreatorFactory = __webpack_require__(/*! ./configuration/api/action-creator-factory */ "./src/configuration/api/action-creator-factory.js");

var _nameProviders = __webpack_require__(/*! ./configuration/api/name-providers */ "./src/configuration/api/name-providers.js");

var _timelineProviderSettingsEditor = _interopRequireDefault(__webpack_require__(/*! ./configuration/api/timeline-provider-settings-editor */ "./src/configuration/api/timeline-provider-settings-editor.js"));

var _ParameterTypes = _interopRequireDefault(__webpack_require__(/*! ./operation/metadata/ParameterTypes */ "./src/operation/metadata/ParameterTypes.js"));
...
var LanguageManager = /*#__PURE__*/function () {
  ...
  _createClass(LanguageManager, [{
    key: "_addEventbusListeners",
    value: function _addEventbusListeners(eventbus) {
      this._eventbusListeners.push(eventbus.on(_timelineEventNames["default"].REQUEST_LABEL_COLLECTION, this._handleRequestLabelCollection.bind(this)));

      this._eventbusListeners.push(eventbus.on(_timelineEventNames["default"].REQUEST_LABEL_COLLECTIONS, this._handleRequestLabelCollections.bind(this)));

      this._eventbusListeners.push(eventbus.on(_timelineEventNames["default"].REQUEST_CURRENT_LANGUAGE, this._handleRequestCurrentLanguage.bind(this)));

      this._eventbusListeners.push(eventbus.on(_timelineEventNames["default"].LANGUAGE_CHANGE, this._handleLanguageChange.bind(this)));
    }
  }, {
    key: "_handleRequestCurrentLanguage",
    value: function _handleRequestCurrentLanguage(resultCallback) {
      resultCallback(this._currentLanguage);
    }
  }, {
    key: "_handleRequestLabelCollection",
    value: function _handleRequestLabelCollection(labelId, resultCallback) {
      resultCallback(this._labelLookup[labelId]);
    }
  }, {
    key: "_handleRequestLabelCollections",
    value: function _handleRequestLabelCollections(labelIds, resultCallback) {
      var _this = this;
    ...
    value: function _handleLanguageChange(language) {
      if (language && language.length) {
        this._currentLanguage = language;
    ...
    key: "_setRootElementLang",
    value: function _setRootElementLang(language) {
      var _this2 = this;

      var callBack = function callBack(rootSelector) {
        var lang = _this2._extractLanguageFromCulture(language);

        (0, _jquery["default"])(rootSelector).attr('lang', lang);
      };

      this.eventbus.broadcast(_timelineEventNames["default"].REQUEST_ENGINE_ROOT, [callBack]);
    }
  }, {
    key: "_extractLanguageFromCulture",
    value: function _extractLanguageFromCulture(culture) {
    ...
    key: "_createLabelLookup",
    value: function _createLabelLookup(labels) {
      var _this3 = this;
...
function clearOperationData(operationData, eventBus) {
  var properties = operationData.properties;
...
/***/ "./src/operation/createElement.js":
/*!****************************************!*\
  !*** ./src/operation/createElement.js ***!
  \****************************************/
/*! no static exports found */
...
function createElement(operationData, eventBus) {
  operationData = (0, _resolvePropertyValues["default"])(operationData, operationData);
  console.dir(operationData);
  var _operationData = operationData,
      elementName = _operationData.elementName,
      attributes = _operationData.attributes,
      text = _operationData.text;
  ...
  var template = text ? (0, _jquery["default"])("<".concat(elementName).concat(serializedAttrs, ">").concat(text, "</").concat(elementName, ">")) : (0, _jquery["default"])("<".concat(elementName).concat(serializedAttrs, "/>"));
...
function getControllerFromElement(operationData, eventBus) {
  ...
  var controller = controllers.find(function (ctrl) {
...
function getImport(operationData, eventBus) {
  ...
  var callBack = function callBack(instance) {
    operationData.importedInstance = instance;
  };

  eventBus.broadcast(_timelineEventNames["default"].REQUEST_FUNCTION, [systemName, callBack]);
  delete operationData.systemName;
  return operationData;
}

var _default = getImport;
exports["default"] = _default;
...
function resolvePropertyValues(operationData, properties) {
  var copy = properties !== operationData ? (0, _deepcopy["default"])(properties) : properties;
...
Object.defineProperty(exports, "endLoop", {
  enumerable: true,
  get: function get() {
    return _endLoop["default"];
  }
});
...
Object.defineProperty(exports, "startLoop", {
  enumerable: true,
  get: function get() {
    return _startLoop["default"];
  }
});
...
var _createElement = _interopRequireDefault(__webpack_require__(/*! ./createElement */ "./src/operation/createElement.js"));
...
var _endLoop = _interopRequireDefault(__webpack_require__(/*! ./endLoop */ "./src/operation/endLoop.js"));
...
var _getImport = _interopRequireDefault(__webpack_require__(/*! ./getImport */ "./src/operation/getImport.js"));

var _loadJSON = _interopRequireDefault(__webpack_require__(/*! ./loadJSON */ "./src/operation/loadJSON.js"));

var _log = _interopRequireDefault(__webpack_require__(/*! ./log */ "./src/operation/log.js"));
...
var _startLoop = _interopRequireDefault(__webpack_require__(/*! ./startLoop */ "./src/operation/startLoop.js"));
...
/***/ "./src/operation/metadata/ParameterTypes.js":
/*!**************************************************!*\
  !*** ./src/operation/metadata/ParameterTypes.js ***!
  \**************************************************/
/*! no static exports found */
...
var ParameterTypes = function ParameterTypes() {
  _classCallCheck(this, ParameterTypes);
};
...
/***/ "./src/operation/metadata/addClass.js":
/*!********************************************!*\
  !*** ./src/operation/metadata/addClass.js ***!
  \********************************************/
/*! no static exports found */
...
var _ParameterTypes = _interopRequireDefault(__webpack_require__(/*! ./ParameterTypes */ "./src/operation/metadata/ParameterTypes.js"));
...
function addClass() {
  return {
    ...
    properties: {
      className: {
        type: _ParameterTypes["default"].CLASS_NAME,
        required: true
      }
    }
  };
...
/***/ "./src/operation/metadata/addControllerToElement.js":
/*!**********************************************************!*\
  !*** ./src/operation/metadata/addControllerToElement.js ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/addOptionList.js":
/*!*************************************************!*\
  !*** ./src/operation/metadata/addOptionList.js ***!
  \*************************************************/
/*! no static exports found */
...
function addOptionList() {
  return {
    ...
    properties: {
      valueProperty: {
        type: _ParameterTypes["default"].STRING,
        required: true
      },
      labelProperty: {
        type: _ParameterTypes["default"].STRING,
      ...
      defaultIndex: _ParameterTypes["default"].INTEGER,
      defaultValue: _ParameterTypes["default"].STRING,
      optionData: _ParameterTypes["default"].ARRAY
    }
  };
}
...
/***/ "./src/operation/metadata/animate.js":
/*!*******************************************!*\
  !*** ./src/operation/metadata/animate.js ***!
  \*******************************************/
/*! no static exports found */
...
function animate() {
  return {
    ...
    dependentProperties: ['selectedElement'],
    properties: {
      animationEasing: _ParameterTypes["default"].BOOLEAN,
      animationProperties: {
        type: _ParameterTypes["default"].OBJECT,
        required: true
      },
      animationDuration: {
        type: _ParameterTypes["default"].INTEGER,
        required: true
      }
    }
  };
...
/***/ "./src/operation/metadata/animateWithClass.js":
/*!****************************************************!*\
  !*** ./src/operation/metadata/animateWithClass.js ***!
  \****************************************************/
/*! no static exports found */
...
function animateWithClass() {
  return {
    ...
    properties: {
      ...
      removeClass: _ParameterTypes["default"].BOOLEAN
    }
  };
}
...
/***/ "./src/operation/metadata/broadcastEvent.js":
/*!**************************************************!*\
  !*** ./src/operation/metadata/broadcastEvent.js ***!
  \**************************************************/
/*! no static exports found */
...
function broadcastEvent() {
  return {
    ...
    properties: {
      eventArgs: _ParameterTypes["default"].ARRAY,
      eventTopic: _ParameterTypes["default"].EVENT_TOPIC,
      eventName: {
        type: _ParameterTypes["default"].EVENT_NAME,
        required: true
      }
    }
  };
...
/***/ "./src/operation/metadata/clearElement.js":
/*!************************************************!*\
  !*** ./src/operation/metadata/clearElement.js ***!
  \************************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/clearOperationData.js":
/*!******************************************************!*\
  !*** ./src/operation/metadata/clearOperationData.js ***!
  \******************************************************/
/*! no static exports found */
...
function clearOperationData() {
  return {
    ...
    properties: {
      properties: _ParameterTypes["default"].ARRAY
    }
  };
}
...
/***/ "./src/operation/metadata/createElement.js":
/*!*************************************************!*\
  !*** ./src/operation/metadata/createElement.js ***!
  \*************************************************/
/*! no static exports found */
...
function customFunction() {
  return {
    ...
    properties: {
      elementName: {
        type: _ParameterTypes["default"].HTML_ELEMENT_NAME,
        required: true
      },
      attributes: _ParameterTypes["default"].OBJECT,
      text: _ParameterTypes["default"].STRING
    },
    outputProperties: {
      template: _ParameterTypes["default"].OBJECT
    }
  };
}
...
/***/ "./src/operation/metadata/customFunction.js":
/*!**************************************************!*\
  !*** ./src/operation/metadata/customFunction.js ***!
  \**************************************************/
/*! no static exports found */
...
function customFunction() {
  return {
    ...
    properties: {
      systemName: _ParameterTypes["default"].SYSTEM_NAME
    }
  };
}
...
/***/ "./src/operation/metadata/endAction.js":
/*!*********************************************!*\
  !*** ./src/operation/metadata/endAction.js ***!
  \*********************************************/
/*! no static exports found */
...
function endAction() {
  return {
    ...
    properties: {
      actionOperationData: _ParameterTypes["default"].OBJECT
    }
  };
}
...
/***/ "./src/operation/metadata/endLoop.js":
/*!*******************************************!*\
  !*** ./src/operation/metadata/endLoop.js ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/extendController.js":
/*!****************************************************!*\
  !*** ./src/operation/metadata/extendController.js ***!
  \****************************************************/
/*! no static exports found */
...
function extendController() {
  return {
    ...
    properties: {
      controllerExtension: _ParameterTypes["default"].OBJECT
    }
  };
}
...
/***/ "./src/operation/metadata/getControllerFromElement.js":
/*!************************************************************!*\
  !*** ./src/operation/metadata/getControllerFromElement.js ***!
  \************************************************************/
/*! no static exports found */
...
function getControllerFromElement() {
  return {
    ...
    properties: {
      controllerName: {
        type: _ParameterTypes["default"].CONTROLLER_NAME,
        required: true
      }
    },
    outputProperties: {
      controllerInstance: _ParameterTypes["default"].OBJECT
    }
  };
}
...
/***/ "./src/operation/metadata/getControllerInstance.js":
/*!*********************************************************!*\
  !*** ./src/operation/metadata/getControllerInstance.js ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/getElementDimensions.js":
/*!********************************************************!*\
  !*** ./src/operation/metadata/getElementDimensions.js ***!
  \********************************************************/
/*! no static exports found */
...
function getElementDimensions() {
  return {
    ...
    dependentProperties: ['selectedElement'],
    properties: {
      modifier: _ParameterTypes["default"].DIMENSIONS_MODIFIER
    },
    outputProperties: {
      dimensions: _ParameterTypes["default"].DIMENSIONS
    }
  };
}
...
/***/ "./src/operation/metadata/getImport.js":
/*!*********************************************!*\
  !*** ./src/operation/metadata/getImport.js ***!
  \*********************************************/
/*! no static exports found */
...
function getImport() {
  return {
    properties: {
      systemName: {
        type: _ParameterTypes["default"].SYSTEM_NAME,
        required: true
      }
    },
    outputProperties: {
      importedInstance: _ParameterTypes["default"].OBJECT
    }
  };
}
...
/***/ "./src/operation/metadata/index.js":
/*!*****************************************!*\
  !*** ./src/operation/metadata/index.js ***!
  \*****************************************/
/*! no static exports found */
...
var _addClass = _interopRequireDefault(__webpack_require__(/*! ./addClass */ "./src/operation/metadata/addClass.js"));

var _addControllerToElement = _interopRequireDefault(__webpack_require__(/*! ./addControllerToElement */ "./src/operation/metadata/addControllerToElement.js"));

var _addOptionList = _interopRequireDefault(__webpack_require__(/*! ./addOptionList */ "./src/operation/metadata/addOptionList.js"));

var _animate = _interopRequireDefault(__webpack_require__(/*! ./animate */ "./src/operation/metadata/animate.js"));

var _animateWithClass = _interopRequireDefault(__webpack_require__(/*! ./animateWithClass */ "./src/operation/metadata/animateWithClass.js"));

var _broadcastEvent = _interopRequireDefault(__webpack_require__(/*! ./broadcastEvent */ "./src/operation/metadata/broadcastEvent.js"));

var _clearElement = _interopRequireDefault(__webpack_require__(/*! ./clearElement */ "./src/operation/metadata/clearElement.js"));

var _clearOperationData = _interopRequireDefault(__webpack_require__(/*! ./clearOperationData */ "./src/operation/metadata/clearOperationData.js"));

var _createElement = _interopRequireDefault(__webpack_require__(/*! ./createElement */ "./src/operation/metadata/createElement.js"));

var _customFunction = _interopRequireDefault(__webpack_require__(/*! ./customFunction */ "./src/operation/metadata/customFunction.js"));

var _endAction = _interopRequireDefault(__webpack_require__(/*! ./endAction */ "./src/operation/metadata/endAction.js"));

var _endLoop = _interopRequireDefault(__webpack_require__(/*! ./endLoop */ "./src/operation/metadata/endLoop.js"));

var _extendController = _interopRequireDefault(__webpack_require__(/*! ./extendController */ "./src/operation/metadata/extendController.js"));

var _getControllerFromElement = _interopRequireDefault(__webpack_require__(/*! ./getControllerFromElement */ "./src/operation/metadata/getControllerFromElement.js"));

var _getControllerInstance = _interopRequireDefault(__webpack_require__(/*! ./getControllerInstance */ "./src/operation/metadata/getControllerInstance.js"));

var _getElementDimensions = _interopRequireDefault(__webpack_require__(/*! ./getElementDimensions */ "./src/operation/metadata/getElementDimensions.js"));

var _getImport = _interopRequireDefault(__webpack_require__(/*! ./getImport */ "./src/operation/metadata/getImport.js"));

var _loadJSON = _interopRequireDefault(__webpack_require__(/*! ./loadJSON */ "./src/operation/metadata/loadJSON.js"));

var _log = _interopRequireDefault(__webpack_require__(/*! ./log */ "./src/operation/metadata/log.js"));

var _removeClass = _interopRequireDefault(__webpack_require__(/*! ./removeClass */ "./src/operation/metadata/removeClass.js"));

var _removeControllerFromElement = _interopRequireDefault(__webpack_require__(/*! ./removeControllerFromElement */ "./src/operation/metadata/removeControllerFromElement.js"));

var _removeElement = _interopRequireDefault(__webpack_require__(/*! ./removeElement */ "./src/operation/metadata/removeElement.js"));

var _removePropertiesFromOperationData = _interopRequireDefault(__webpack_require__(/*! ./removePropertiesFromOperationData */ "./src/operation/metadata/removePropertiesFromOperationData.js"));

var _reparentElement = _interopRequireDefault(__webpack_require__(/*! ./reparentElement */ "./src/operation/metadata/reparentElement.js"));

var _requestAction = _interopRequireDefault(__webpack_require__(/*! ./requestAction */ "./src/operation/metadata/requestAction.js"));

var _resizeAction = _interopRequireDefault(__webpack_require__(/*! ./resizeAction */ "./src/operation/metadata/resizeAction.js"));

var _selectElement = _interopRequireDefault(__webpack_require__(/*! ./selectElement */ "./src/operation/metadata/selectElement.js"));

var _setElementAttributes = _interopRequireDefault(__webpack_require__(/*! ./setElementAttributes */ "./src/operation/metadata/setElementAttributes.js"));

var _setElementContent = _interopRequireDefault(__webpack_require__(/*! ./setElementContent */ "./src/operation/metadata/setElementContent.js"));

var _setOperationData = _interopRequireDefault(__webpack_require__(/*! ./setOperationData */ "./src/operation/metadata/setOperationData.js"));

var _setStyle = _interopRequireDefault(__webpack_require__(/*! ./setStyle */ "./src/operation/metadata/setStyle.js"));

var _startAction = _interopRequireDefault(__webpack_require__(/*! ./startAction */ "./src/operation/metadata/startAction.js"));

var _startLoop = _interopRequireDefault(__webpack_require__(/*! ./startLoop */ "./src/operation/metadata/startLoop.js"));

var _toggleClass = _interopRequireDefault(__webpack_require__(/*! ./toggleClass */ "./src/operation/metadata/toggleClass.js"));

var _toggleElement = _interopRequireDefault(__webpack_require__(/*! ./toggleElement */ "./src/operation/metadata/toggleElement.js"));

var _wait = _interopRequireDefault(__webpack_require__(/*! ./wait */ "./src/operation/metadata/wait.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

/***/ }),

/***/ "./src/operation/metadata/loadJSON.js":
/*!********************************************!*\
  !*** ./src/operation/metadata/loadJSON.js ***!
  \********************************************/
/*! no static exports found */
...
function loadJSON() {
  return {
    ...
    properties: {
      url: {
        type: _ParameterTypes["default"].URL,
        required: true
      },
      cache: _ParameterTypes["default"].BOOLEAN,
      propertyName: {
        type: _ParameterTypes["default"].STRING,
        defaultValue: 'json'
      }
...
/***/ "./src/operation/metadata/removeClass.js":
/*!***********************************************!*\
  !*** ./src/operation/metadata/removeClass.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/removeControllerFromElement.js":
/*!***************************************************************!*\
  !*** ./src/operation/metadata/removeControllerFromElement.js ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/removeElement.js":
/*!*************************************************!*\
  !*** ./src/operation/metadata/removeElement.js ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/removePropertiesFromOperationData.js":
/*!*********************************************************************!*\
  !*** ./src/operation/metadata/removePropertiesFromOperationData.js ***!
  \*********************************************************************/
/*! no static exports found */
...
function removePropertiesFromOperationData() {
  return {
    ...
    properties: {
      propertyNames: _ParameterTypes["default"].ARRAY
    }
  };
}
...
/***/ "./src/operation/metadata/reparentElement.js":
/*!***************************************************!*\
  !*** ./src/operation/metadata/reparentElement.js ***!
  \***************************************************/
/*! no static exports found */
...
function reparentElement() {
  return {
    ...
    properties: {
      newParentSelector: {
        type: _ParameterTypes["default"].SELECTOR,
        required: true
      }
    }
  };
...
/***/ "./src/operation/metadata/requestAction.js":
/*!*************************************************!*\
  !*** ./src/operation/metadata/requestAction.js ***!
  \*************************************************/
/*! no static exports found */
...
function requestAction() {
  return {
    ...
    properties: {
      systemName: {
        type: _ParameterTypes["default"].ACTION_NAME
      }
    },
    outputProperties: {
      actionInstance: _ParameterTypes["default"].OBJECT
    }
  };
}
...
/***/ "./src/operation/metadata/resizeAction.js":
/*!************************************************!*\
  !*** ./src/operation/metadata/resizeAction.js ***!
  \************************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/selectElement.js":
/*!*************************************************!*\
  !*** ./src/operation/metadata/selectElement.js ***!
  \*************************************************/
/*! no static exports found */
...
function selectElement() {
  return {
    ...
    properties: {
      ...
      propertyName: _ParameterTypes["default"].STRING,
      useSelectedElementAsRoot: _ParameterTypes["default"].BOOLEAN
    },
    outputProperties: {
      selectedElement: _ParameterTypes["default"].OBJECT
    }
  };
}
...
/***/ "./src/operation/metadata/setElementAttributes.js":
/*!********************************************************!*\
  !*** ./src/operation/metadata/setElementAttributes.js ***!
  \********************************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/setElementContent.js":
/*!*****************************************************!*\
  !*** ./src/operation/metadata/setElementContent.js ***!
  \*****************************************************/
/*! no static exports found */
...
function setElementContent() {
  return {
    ...
    dependentProperties: ['selectedElement'],
    properties: {
      append: _ParameterTypes["default"].BOOLEAN,
      template: {
        type: _ParameterTypes["default"].HTML_CONTENT,
        required: true
      }
    }
  };
...
/***/ "./src/operation/metadata/setOperationData.js":
/*!****************************************************!*\
  !*** ./src/operation/metadata/setOperationData.js ***!
  \****************************************************/
/*! no static exports found */
...
function setOperationData() {
  return {
    ...
    properties: {
      ...
      override: _ParameterTypes["default"].BOOLEAN
    }
  };
}
...
/***/ "./src/operation/metadata/setStyle.js":
/*!********************************************!*\
  !*** ./src/operation/metadata/setStyle.js ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/startAction.js":
/*!***********************************************!*\
  !*** ./src/operation/metadata/startAction.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/startLoop.js":
/*!*********************************************!*\
  !*** ./src/operation/metadata/startLoop.js ***!
  \*********************************************/
/*! no static exports found */
...
function startLoop() {
  return {
    ...
    properties: {
      collection: {
        type: _ParameterTypes["default"].ARRAY,
        required: true
      },
      propertyName: {
        type: _ParameterTypes["default"].STRING,
...
var _default = startLoop;
exports["default"] = _default;

/***/ }),

/***/ "./src/operation/metadata/toggleClass.js":
/*!***********************************************!*\
  !*** ./src/operation/metadata/toggleClass.js ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/toggleElement.js":
/*!*************************************************!*\
  !*** ./src/operation/metadata/toggleElement.js ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/operation/metadata/wait.js":
/*!****************************************!*\
  !*** ./src/operation/metadata/wait.js ***!
  \****************************************/
/*! no static exports found */
...
function requestAction(operationData, eventBus) {
  ...
  eventBus.broadcast(_timelineEventNames["default"].REQUEST_ACTION, [systemName, resultCallback]);
  return operationData;
}
...
function selectElement(operationData, eventBus) {
  var selector = operationData.selector,
      _operationData$proper = operationData.propertyName,
      propertyName = _operationData$proper === void 0 ? 'selectedElement' : _operationData$proper,
      useSelectedElementAsRoot = operationData.useSelectedElementAsRoot;
...
function setOperationData(operationData, eventBus) {
  var _operationData = operationData,
      override = _operationData.override,
      properties = _operationData.properties;
  var resolvedProperties = (0, _resolvePropertyValues["default"])(operationData, properties);

  if (override) {
    operationData = resolvedProperties;
  } else {
    operationData = _extends(operationData, resolvedProperties);
  }
...
function startLoop(operationData, eventBus) {
  var context = this;
  var collection = operationData.collection;
  var propertyName = operationData.propertyName;
...
TimelineEventNames.PROVIDERID_REQUEST = 'timeline-providerid-request';
...
Object.defineProperty(exports, "MediaElementTimelineProvider", {
  enumerable: true,
  get: function get() {
    return _mediaelementTimelineProvider["default"];
  }
});
...
var _mediaelementTimelineProvider = _interopRequireDefault(__webpack_require__(/*! ./mediaelement-timeline-provider */ "./src/timelineproviders/mediaelement-timeline-provider.js"));
...
var JwPlayerTimelineProvider = /*#__PURE__*/function () {
  ...
  _createClass(JwPlayerTimelineProvider, [{
    ...
    value: function _handlePlayerComplete() {
      if (!this.loop) {
        this.stop();
        this.eventbus.broadcastForTopic(_timelineEventNames["default"].COMPLETE, this.providerid, [this.player.getPlaylistIndex()]);
      }
    }
  }, {
    key: "_seekedHandler",
    value: function _seekedHandler() {
      this.eventbus.broadcastForTopic(_timelineEventNames["default"].SEEKED, this.providerid, [this.getPosition(), this.getDuration()]);
    }
  }, {
    key: "destroy",
    value: function destroy() {
    ...
    value: function _addEventListeners() {
      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].PLAY_TOGGLE_REQUEST, this.toggleplay.bind(this), this.providerid));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].PLAY_REQUEST, this.play.bind(this), this.providerid));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].STOP_REQUEST, this.stop.bind(this), this.providerid));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].PAUSE_REQUEST, this.pause.bind(this), this.providerid));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].SEEK_REQUEST, this.seek.bind(this), this.providerid));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].RESIZE_REQUEST, this.resize.bind(this), this.providerid));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].CONTAINER_REQUEST, this._container.bind(this), this.providerid));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].DURATION_REQUEST, this.duration.bind(this), this.providerid));
    }
  }, {
    key: "_container",
    value: function _container(resultCallback) {
      ...
      var container = (0, _jquery["default"])("#".concat(this.providerid).concat(suffix));
    ...
    value: function play() {
      this.paused = false;
      this.player.play();
      this.eventbus.broadcastForTopic(_timelineEventNames["default"].PLAY, this.providerid);
    }
  }, {
    key: "stop",
    value: function stop() {
      this.paused = false;
      this.player.stop();
      this.eventbus.broadcastForTopic(_timelineEventNames["default"].STOP, this.providerid);
    }
  }, {
    key: "pause",
    value: function pause() {
      this.paused = true;
      this.player.pause();
      this.eventbus.broadcastForTopic(_timelineEventNames["default"].PAUSE, this.providerid);
    }
  }, {
    key: "seek",
    value: function seek(position) {
      ...
      this.eventbus.broadcastForTopic(_timelineEventNames["default"].SEEK, this.providerid, [position, currentPosition, this.player.getDuration()]);
    }
  }, {
    key: "resize",
    value: function resize(width, height) {
      this.player.resize(width, height);
      this.eventbus.broadcastForTopic(_timelineEventNames["default"].RESIZE, this.providerid, [width, height]);
    }
  }, {
    key: "duration",
...
/***/ "./src/timelineproviders/mediaelement-timeline-provider.js":
/*!*****************************************************************!*\
  !*** ./src/timelineproviders/mediaelement-timeline-provider.js ***!
  \*****************************************************************/
/*! no static exports found */
...
var _mediaelement = _interopRequireDefault(__webpack_require__(/*! mediaelement */ "./node_modules/mediaelement/full.js"));
...
var MediaElementTimelineProvider = /*#__PURE__*/function () {
  function MediaElementTimelineProvider(eventbus, config) {
    _classCallCheck(this, MediaElementTimelineProvider);
  ...
  _createClass(MediaElementTimelineProvider, [{
    key: "_addEventListeners",
    value: function _addEventListeners() {
    ...
    value: function init(selector) {
      ...
      var promise = new Promise(function (resolve) {
        self.player = new _mediaelement["default"](document.getElementById("#".concat(_this._videoElementId)), {
    ...
    key: "_addVideoElements",
    value: function _addVideoElements(selector, urls) {
      var _this2 = this;

      this._videoElementId = (0, _uuid.v4)();
      var videoElm = ["<video class='mejs__player' id=".concat(this._videoElementId, ">")];
      urls.forEach(function (url) {
        videoElm.push("<source src='".concat(url, "' type='").concat(_this2._extractFileType(url), "'/>"));
      });
      videoElm.push('</video>');
      (0, _jquery["default"])(selector).append(videoElm.join(''));
    }
  }, {
    key: "_extractFileType",
    value: function _extractFileType(url) {
      var lastIdx = url.lastIndexOf('.');
      return "video/".concat(url.substr(lastIdx + 1));
    }
  }, {
    key: "play",
    value: function play() {
    ...
    value: function destroy() {
      this.stop();
      (0, _jquery["default"])(this._videoElementId).remove();
  ...
  return MediaElementTimelineProvider;
}();

var _default = MediaElementTimelineProvider;
exports["default"] = _default;
...
var RequestAnimationFrameTimelineProvider = /*#__PURE__*/function () {
  function RequestAnimationFrameTimelineProvider(eventbus, config) {
    ...
    this.loop = false;
    this._eventbusListeners = [];
    this.providerid = "provider".concat(Math.random() * 1000);
    this.playlist = [];
  ...
  _createClass(RequestAnimationFrameTimelineProvider, [{
    ...
    key: "playlistItem",
    value: function playlistItem(uri) {
      if (uri === null || !uri.length || this.playlist.length === 0) {
        return;
      }

      this.currentPlaylistItem = this.playlist.find(function (item) {
        return item.uri === uri;
      });
      this.firstFrame = true;
    }
    ...
    value: function _addEventListeners() {
      ...
      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].RESIZE_REQUEST, this._resize.bind(this), this.providerid));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].CONTAINER_REQUEST, this._container.bind(this), this.providerid));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].DURATION_REQUEST, this.requestDurationHandler.bind(this), this.providerid));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].PROVIDERID_REQUEST, this.requestProviderIdHandler.bind(this)));
    }
  }, {
    key: "_update",
    value: function _update(now) {
      ...
      if (!this.last || now - this.last >= this.granularity) {
        if (!this.last && this.firstFrame) {
          ...
          this.eventbus.broadcastForTopic(_timelineEventNames["default"].FIRSTFRAME, this.providerid);
        }
        ...
        if (this.current > this.currentPlaylistItem.duration) {
          if (this.loop) {
            ...
            this.stop();
            this.eventbus.broadcastForTopic(_timelineEventNames["default"].COMPLETE, this.providerid);
            return;
          }
        }

        this.eventbus.broadcastForTopic(_timelineEventNames["default"].TIME, this.providerid, [{
          position: this.current
        }]);
        this.eventbus.broadcastForTopic(_timelineEventNames["default"].POSITION_UPDATE, this.providerid, [{
          position: this.current,
          duration: this.currentPlaylistItem.duration
        }]);
      }
    ...
    value: function init() {
      ...
      if (!this.container.length) {
        throw new Error("timeline selector '".concat(this.currentPlaylistItem.selector, "' not found"));
      }
    ...
    value: function seek(position) {
      ...
      this.eventbus.broadcastForTopic(_timelineEventNames["default"].SEEK, this.providerid);
      this.current = position;
      this.eventbus.broadcastForTopic(_timelineEventNames["default"].SEEKED, this.providerid);
    }
  }, {
    key: "getPosition",
    value: function getPosition() {
    ...
    key: "requestProviderIdHandler",
    value: function requestProviderIdHandler(callBack) {
...
module.exports = __webpack_require__(/*! D:\Projects\Rosetta\chrono-trigger\src\index.js */"./src/index.js");
