...
function () {
  ...
  _createClass(OperationEditor, [{
    ...
    value: function setSystemName(systemName) {
      ...
      this.operationConfig = _objectSpread({}, this.operationConfig, {
        systemName: systemName
      });
      return this;
    }
    ...
    value: function setOperationDataItem(key, value) {
      ...
      operationData = (_readOnlyError("operationData"), _objectSpread({}, operationData, _defineProperty({}, key, value)));
...
function animate() {
  return {
    ...
    dependentProperties: ['selectedElement'],
    animationEasing: {
      type: _ParameterTypes["default"].BOOLEAN
    },
    animationProperties: {
      type: _ParameterTypes["default"].OBJECT,
      required: true
...
function broadcastEvent() {
  return {
    ...
    eventTopic: {
      type: _ParameterTypes["default"].EVENT_TOPIC
    },
    eventName: {
...
function getControllerFromElement() {
  return {
    controllerName: _ParameterTypes["default"].CONTROLLER_NAME,
    required: true
  };
}
...
function getElementDimensions() {
  return {
    dimensions: {
      type: _ParameterTypes["default"].DIMENSIONS
    },
    modifier: {
      type: _ParameterTypes["default"].DIMENSIONS_MODIFIER
    }
  };
}
