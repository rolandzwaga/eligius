...
function () {
  ...
  _createClass(ActionEditor, [{
    ...
    value: function editStartOperation(id) {
      var operation = this.actionConfig.startOperations.find(function (o) {
        return o.id === id;
      });
    ...
    value: function removeStartOperation(id) {
      ...
      var idx = this.actionConfig.startOperations.indexOf(operation);
...
function (_ActionEditor) {
  ...
  _createClass(EndableActionEditor, [{
    ...
    value: function editEndOperation(id) {
      var operationConfig = this.actionConfig.endOperations.find(function (o) {
        return o.id === id;
      });
    ...
    value: function removeEndOperation(id) {
      var operation = this.actionConfig.endOperations.find(function (o) {
        return o.id === id;
      });
      var idx = this.actionConfig.endOperations.indexOf(operation);
