...
var _mergeOperationData = _interopRequireDefault(__webpack_require__(3));
...
var actions = _interopRequireWildcard(__webpack_require__(6));

var _chronoTriggerEngine = _interopRequireDefault(__webpack_require__(14));

var _engineFactory = _interopRequireDefault(__webpack_require__(15));

var _timelineEventNames = _interopRequireDefault(__webpack_require__(0));

var _languageManager = _interopRequireDefault(__webpack_require__(9));

var _webpackResourceImporter = _interopRequireDefault(__webpack_require__(21));
...
var _action = _interopRequireDefault(__webpack_require__(7));

var _endableaction = _interopRequireDefault(__webpack_require__(8));

var _timelineaction = _interopRequireDefault(__webpack_require__(13));
  ...
  _createClass(Action, [{
    ...
    value: function executeOperation(operations, idx, resolve, reject, previousOperationData) {
      ...
      if (idx < operations.length) {
        ...
        var copy = operationInfo.operationData ? JSON.parse(JSON.stringify(operationInfo.operationData)) : {};
...
var _getNestedValue = _interopRequireDefault(__webpack_require__(10));
...
var _extractOperationDataArgumentValues = _interopRequireDefault(__webpack_require__(11));
...
function () {
  ...
  _createClass(ChronoTriggerEngine, [{
    ...
    key: "createLayoutTemplate",
    value: function createLayoutTemplate() {
    ...
    key: "initializeTimelineProvider",
    value: function initializeTimelineProvider() {
      var _this = this;
      ...
      if (playerContainer.length) {
        return new Promise(function (resolve) {
          _this.timelineProvider.init().then(function () {
            _this.executeActions(_this.configuration.initActions, "start").then(function () {
              _this.timelineProvider.on(_timelineEventNames["default"].TIME, _this.onTimeHandler.bind(_this, Math.floor));

              _this.timelineProvider.on(_timelineEventNames["default"].SEEK, _this.onSeekHandler.bind(_this, Math.floor));
    ...
    key: "addInitialisationListeners",
    value: function addInitialisationListeners() {
      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].REQUEST_ENGINE_ROOT, this.handleRequestEngineRoot.bind(this, this.configuration.containerSelector)));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].REQUEST_TIMELINE_URI, this.handleRequestTimelineUri.bind(this)));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].REQUEST_CURRENT_TIMELINE_POSITION, this.handleRequestTimelinePosition.bind(this)));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].REQUEST_TIMELINE_CLEANUP, this.handleTimelineComplete.bind(this)));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].EXECUTE_TIMELINEACTION, this.handleExecuteTimelineAction.bind(this)));

      this._eventbusListeners.push(this.eventbus.on(_timelineEventNames["default"].RESIZE_TIMELINEACTION, this.resizeTimelineAction.bind(this)));
    }
  }, {
    key: "createTimelineLookup",
    value: function createTimelineLookup() {
      var _this2 = this;
      ...
      this.configuration.timelines.forEach(function (timelineInfo) {
        timelineInfo.timelineActions.forEach(_this2.addTimelineAction.bind(_this2, timelineInfo.uri));
      });
    }
  }, {
    key: "addTimelineAction",
    value: function addTimelineAction(uri, timeLineAction) {
      var start = timeLineAction.duration.start;
      var timelineStartPositions = this.initializeTimelinePosition(this.initializeUriLookup(this._timeLineActionsLookup, uri), start);
      ...
      if (isFinite(end)) {
        var timelineEndPositions = this.initializeTimelinePosition(this._timeLineActionsLookup[uri], end);
        var endMethod = timeLineAction.end.bind(timeLineAction);
        timelineEndPositions.push(endMethod);
      }
    }
  }, {
    key: "initializeUriLookup",
    value: function initializeUriLookup(lookup, uri) {
      if (!lookup[uri]) {
        lookup[uri] = {};
      }
    ...
    key: "initializeTimelinePosition",
    value: function initializeTimelinePosition(lookup, position) {
      if (!lookup[position]) {
        lookup[position] = [];
      }
    ...
    key: "executeActions",
    value: function executeActions(actions, methodName) {
      var _this3 = this;
      ...
      if (idx < actions.length) {
        ...
        return promise.then(function () {
          return _this3.executeActions(actions, methodName, ++idx);
        });
      }
    ...
    key: "handleRequestEngineRoot",
    value: function handleRequestEngineRoot(engineRootSelector, resultCallback) {
      resultCallback((0, _jquery["default"])(engineRootSelector));
    }
  }, {
    key: "handleRequestTimelineUri",
    value: function handleRequestTimelineUri(index, position, previousVideoPosition) {
      var _this4 = this;

      position = position || 0;
      previousVideoPosition = previousVideoPosition || 0;
      this.timelineProvider.stop();
      this.cleanUpTimeline().then(function () {
        var timelineConfig = _this4.configuration.timelines[index];
        _this4._currentVideoUri = timelineConfig.uri;
        ...
        if (!_this4.timelineProvider.loop && position > 0) {
          _this4.timelineProvider.once(_timelineEventNames["default"].FIRST_FRAME, function () {
            ...
            _this4.executeStartActions().then(function () {
              _this4.timelineProvider.seek(position);

              _this4.onSeekHandler(Math.floor, {
                offset: position
              });
            });
          });
    ...
    key: "executeRelevantActions",
    value: function executeRelevantActions(filter, executionType) {
      var timelineActions = this.getRelevantTimelineActions();
      var currentActions = filter.apply(this, [timelineActions]);
      return this.executeActions(currentActions, executionType, 0);
    }
  }, {
    key: "handleRequestTimelinePosition",
    value: function handleRequestTimelinePosition(resultCallback) {
      resultCallback(Math.floor(this.timelineProvider.getPosition()));
    }
  }, {
    key: "handleTimelineComplete",
    value: function handleTimelineComplete() {
      this.cleanUpTimeline();
    }
  }, {
    key: "handleExecuteTimelineAction",
    value: function handleExecuteTimelineAction(uri, index, start) {
      var actions = this.getTimelineActionsForUri(uri);
    ...
    key: "resizeTimelineAction",
    value: function resizeTimelineAction(uri, index) {
      var actions = this.getTimelineActionsForUri(uri);
      var action = actions ? actions[index] : null;
    ...
    key: "getRelevantTimelineActions",
    value: function getRelevantTimelineActions() {
      return this.getTimelineActionsForUri(this._currentVideoUri);
    }
  }, {
    key: "getTimelineActionsForUri",
    value: function getTimelineActionsForUri(uri) {
      var timelineActions;
    ...
    key: "onTimeHandler",
    value: function onTimeHandler(floor, event) {
    ...
    key: "onSeekHandler",
    value: function onSeekHandler(floor, event) {
      var _this5 = this;
      ...
      this.executeSeekActions(pos).then(function () {
        _this5.timelineProvider.play();
      });
    }
  }, {
    key: "executeActionsForPosition",
    value: function executeActionsForPosition(position) {
      this._lastPosition = position;
      var actions = this._timeLineActionsLookup[this._currentVideoUri];
    ...
    key: "executeSeekActions",
    value: function executeSeekActions(pos) {
      var _this6 = this;

      var timelineActions = this.getRelevantTimelineActions();
      var currentActions = this.getActiveActions(timelineActions);
      var newActions = this.getActionsForPosition(pos, timelineActions);
      var promise = this.executeActions(currentActions, "end", 0);
      return new Promise(function (resolve) {
        promise.then(function () {
          _this6.executeActions(newActions, "start", 0).then(function () {
            resolve();
          });
        });
      });
...
var _configurationResolver = _interopRequireDefault(__webpack_require__(20));
...
function () {
  ...
  _createClass(EngineFactory, [{
    key: "init",
    value: function init(importer, windowRef, eventbus) {
      this.resizeTimeout = -1;
      this.actionsLookup = null;
      this.importer = importer;
      this.eventBus = eventbus || new _eventbus.Eventbus();
      this.eventBus.on(_timelineEventNames["default"].REQUEST_INSTANCE, this.requestInstanceHandler.bind(this));
      this.eventBus.on(_timelineEventNames["default"].REQUEST_ACTION, this.requestActionHandler.bind(this));
      this.eventBus.on(_timelineEventNames["default"].REQUEST_FUNCTION, this.requestFunctionHandler.bind(this));
      (0, _jquery["default"])(windowRef).resize(this.resizeHandler.bind(this));
    }
  }, {
    key: "destroy",
    value: function destroy() {
    ...
    key: "importSystemEntryWithEventbusDependency",
    value: function importSystemEntryWithEventbusDependency(systemName) {
      var ctor = this.importSystemEntry(systemName);
    ...
    key: "requestInstanceHandler",
    value: function requestInstanceHandler(systemName, resultCallback) {
      resultCallback(this.importSystemEntryWithEventbusDependency(systemName));
    }
  }, {
    key: "requestFunctionHandler",
    value: function requestFunctionHandler(systemName, resultCallback) {
      resultCallback(this.importSystemEntry(systemName));
    }
  }, {
    key: "requestActionHandler",
    value: function requestActionHandler(systemName, resultCallback) {
    ...
    key: "createEngine",
    value: function createEngine(configuration) {
      var systemName = configuration.engine.systemName;
      var engineClass = this.importSystemEntry(systemName);
      ...
      var resolver = new _configurationResolver["default"](this.importer, this.eventBus);
      this.actionsLookup = resolver.process(actionRegistryListener, configuration);
      var timelineProviderClass = this.importSystemEntry(configuration.timelineProviderSettings.systemName);
...
var _eventbus = _interopRequireDefault(__webpack_require__(17));

var _actionregistryEventbusListener = _interopRequireDefault(__webpack_require__(18));

var _requestVideoUriInterceptor = _interopRequireDefault(__webpack_require__(19));
...
function () {
  ...
  _createClass(Eventbus, [{
    ...
    key: "getEventInterceptors",
    value: function getEventInterceptors(eventName, eventTopic) {
    ...
    value: function getEventHandlers(eventName, eventTopic) {
      if (eventTopic && eventTopic.length) {
        eventName = "".concat(eventName, ":").concat(eventTopic);
      }
    ...
    value: function off(eventName, eventHandler, eventTopic) {
      var handlers = this.getEventHandlers(eventName, eventTopic);
    ...
    value: function registerInterceptor(eventName, interceptor, eventTopic) {
      var interceptors = this.getEventInterceptors(eventName, eventTopic);
      interceptors.push(interceptor);
    }
  }, {
    key: "callHandlers",
    value: function callHandlers(eventName, eventTopic) {
...
function () {
  ...
  _createClass(ConfigurationResolver, [{
    ...
    value: function processConfiguration(config, parentConfig) {
      ...
      if (config.constructor === Array) {
        ...
        Object.keys(config).forEach(function (key) {
          _this6._processConfigProperty(key, config, parentConfig);
        });
      }
    }
  }, {
    key: "_processConfigProperty",
    value: function _processConfigProperty(key, config, parentConfig) {
    ...
    key: "_getNestedPropertyValue",
    value: function _getNestedPropertyValue(propertyChain, sourceObject) {
...
var controllers = _interopRequireWildcard(__webpack_require__(22));

var operations = _interopRequireWildcard(__webpack_require__(31));

var providers = _interopRequireWildcard(__webpack_require__(67));

var main = _interopRequireWildcard(__webpack_require__(5));
...
var _EventListenerController = _interopRequireDefault(__webpack_require__(23));

var _LabelController = _interopRequireDefault(__webpack_require__(24));

var _LottieController = _interopRequireDefault(__webpack_require__(25));

var _NavigationController = _interopRequireDefault(__webpack_require__(27));

var _ProgressbarController = _interopRequireDefault(__webpack_require__(28));

var _RoutingController = _interopRequireDefault(__webpack_require__(29));

var _SubtitlesController = _interopRequireDefault(__webpack_require__(30));
...
function () {
  ...
  _createClass(EventListenerController, [{
    ...
    value: function attach(eventbus) {
      ...
      if (!this.actions) {
        this.actions = [];
        this.operationData.actions.forEach(function (actionName) {
          var _this$isStartAction = _this.isStartAction(actionName),
              _this$isStartAction2 = _slicedToArray(_this$isStartAction, 2),
              doStart = _this$isStartAction2[0],
              name = _this$isStartAction2[1];
    ...
    key: "isStartAction",
    value: function isStartAction(actionName) {
    ...
    value: function eventHandler(event) {
      var copy = this.operationData.actionOperationData ? JSON.parse(JSON.stringify(this.operationData.actionOperationData)) : {};
    ...
    key: "executeAction",
    value: function executeAction(actions, operationData, idx) {
      var _this2 = this;
      ...
      if (idx < actions.length) {
        ...
        if (act.start) {
          ...
          action.start(operationData).then(function (resultOperationData) {
            return _this2.executeAction(actions, _jquery["default"].extend(operationData, resultOperationData), ++idx);
          });
        } else {
          //console.debug("End action: " + action.name);
          action.end().then(function (resultOperationData) {
            return _this2.executeAction(actions, _jquery["default"].extend(operationData, resultOperationData), ++idx);
          });
        }
      }
    ...
    key: "selectEventHandler",
    value: function selectEventHandler(event) {
      ...
      for (var i = 0, l = options.length; i < l; i++) {
        ...
        if (opt.selected) {
          var copy = this.operationData.actionOperationData ? JSON.parse(JSON.stringify(this.operationData.actionOperationData)) : {};
          this.executeAction(this.actions, _jquery["default"].extend({
            eventArgs: [opt.value]
          }, copy), 0);
          break;
        }
...
function () {
  ...
  _createClass(LabelController, [{
    key: "init",
    value: function init(operationData) {
      this.operationData = _jquery["default"].extend({}, operationData, true);
    }
  }, {
    key: "attach",
    value: function attach(eventbus) {
...
var _lottieWeb = _interopRequireDefault(__webpack_require__(26));
...
var _addControllerToElement = _interopRequireDefault(__webpack_require__(33));

var _addOptionList = _interopRequireDefault(__webpack_require__(35));

var _animate = _interopRequireDefault(__webpack_require__(36));

var _animateWithClass = _interopRequireDefault(__webpack_require__(37));

var _broadcastEvent = _interopRequireDefault(__webpack_require__(38));

var _clearElement = _interopRequireDefault(__webpack_require__(41));

var _clearOperationData = _interopRequireDefault(__webpack_require__(42));

var _customFunction = _interopRequireDefault(__webpack_require__(43));

var _endAction = _interopRequireDefault(__webpack_require__(44));

var _extendController = _interopRequireDefault(__webpack_require__(45));

var _getControllerFromElement = _interopRequireDefault(__webpack_require__(46));

var _getControllerInstance = _interopRequireDefault(__webpack_require__(47));

var _getElementDimensions = _interopRequireDefault(__webpack_require__(48));

var _loadJSON = _interopRequireDefault(__webpack_require__(50));

var _removeClass = _interopRequireDefault(__webpack_require__(51));

var _removeControllerFromElement = _interopRequireDefault(__webpack_require__(52));

var _removeElement = _interopRequireDefault(__webpack_require__(53));

var _removePropertiesFromOperationData = _interopRequireDefault(__webpack_require__(54));

var _reparentElement = _interopRequireDefault(__webpack_require__(55));

var _requestAction = _interopRequireDefault(__webpack_require__(56));

var _resizeAction = _interopRequireDefault(__webpack_require__(57));

var _selectElement = _interopRequireDefault(__webpack_require__(58));

var _setElementAttributes = _interopRequireDefault(__webpack_require__(59));

var _setElementContent = _interopRequireDefault(__webpack_require__(60));

var _setOperationData = _interopRequireDefault(__webpack_require__(61));

var _setStyle = _interopRequireDefault(__webpack_require__(62));

var _startAction = _interopRequireDefault(__webpack_require__(63));

var _toggleClass = _interopRequireDefault(__webpack_require__(64));

var _toggleElement = _interopRequireDefault(__webpack_require__(65));

var _wait = _interopRequireDefault(__webpack_require__(66));
...
var _attachControllerToElement = _interopRequireDefault(__webpack_require__(34));

var _internalResolve = _interopRequireDefault(__webpack_require__(2));
...
var _getElementData = __webpack_require__(4);
...
var _resolveEventArguments = _interopRequireDefault(__webpack_require__(39));

var _removeEventDataFromOperationData = _interopRequireDefault(__webpack_require__(40));
...
var _modifyDimensions = _interopRequireDefault(__webpack_require__(49));
...
var _resolvePropertyValues = _interopRequireDefault(__webpack_require__(12));
...
var _jwplayerTimelineProvider = _interopRequireDefault(__webpack_require__(68));

var _requestAnimationFrameTimelineProvider = _interopRequireDefault(__webpack_require__(69));
