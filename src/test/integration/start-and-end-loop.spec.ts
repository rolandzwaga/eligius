...
StartEndLoop('should loop the given operation 10 times', async () => {
  const eventBus = new Eventbus();
  const action = new Action('test', [], eventBus);
...
StartEndLoop('should loop the given async operation 10 times', async () => {
  const eventBus = new Eventbus();
  const action = new Action('test', [], eventBus);
...
StartEndLoop('should skip the loop for an empty collection', async () => {
  const eventBus = new Eventbus();
  const action = new Action('test', [], eventBus);
...
StartEndLoop('should skip the loop for a null collection', async () => {
  const eventBus = new Eventbus();
  const action = new Action('test', [], eventBus);
