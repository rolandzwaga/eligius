...
describe<SubtitleEditorSuiteContext>('SubtitleEditor', () => {
  ...
  test<SubtitleEditorSuiteContext>('Should add empty collections for each language', ({ subtitleEditor }) => {
  ...
  test<SubtitleEditorSuiteContext>('Should add subtitle for given duration and languages', ({ subtitleEditor }) => {
  ...
  test<SubtitleEditorSuiteContext>('Should throw when duplicate language is added', ({ subtitleEditor }) => {
    expect(() =>
