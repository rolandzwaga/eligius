    ...
    (function () {
      ...
      (t.tokenizer = (e, n) => {
        ...
        if (Array.isArray(e))
          return e.map(
            v =>
              new t.Token(t.utils.asString(v).toLowerCase(), t.utils.clone(n))
          );
        for (
...
`,
      ...
      (t.Index = function (e) {
        ...
        (t.Index.prototype.query = function (e) {
            ...
            for (var f = 0; f < d.length; f++) {
              ...
              for (var S = 0; S < L.length; S++)
                for (
                  ...
                  if ((i[m].upsert(_, u.boost, (Qe, Ce) => Qe + Ce), !s[j])) {
          ...
          return y.sort((Te, ke) => ke.score - Te.score);
        }),
...
`);
  ...
  var Z = class extends C {
    constructor(n) {
      ...
      const i = this.summary.querySelector('a');
      i &&
